...
document.getElementById("shakeItTeam1L").innerText = shakeItTeam1;
...
document.getElementById("shakeItTeam2L").innerText = shakeItTeam2;
...
document.getElementById("shakeItTeam3L").innerText = shakeItTeam3;
...
document.getElementById("shakeItTeam4L").innerText = shakeItTeam4;
...
document.getElementById("shakeItTeam5L").innerText = shakeItTeam5;
...
document.getElementById("shakeItTeam6L").innerText = shakeItTeam6;
...
document.getElementById("shakeItTeam7L").innerText = shakeItTeam7;
...
document.getElementById("shakeItTeam8L").innerText = shakeItTeam8;
...
document.getElementById("shakeItTeam9L").innerText = shakeItTeam9;
...
document.getElementById("shakeItTeam10L").innerText = shakeItTeam10;
...
document.getElementById("shakeItTeam11L").innerText = shakeItTeam11;
...
document.getElementById("shakeItTeam12L").innerText = shakeItTeam12;
...
// Sort the array based on team rank
teamArray.sort((a, b) => {
    const rankA = parseInt(a.querySelector('.team').innerText);
    const rankB = parseInt(b.querySelector('.team').innerText);
    const teamRankA = parseInt(document.getElementById(`team${rankA}Rank`).innerText);
    const teamRankB = parseInt(document.getElementById(`team${rankB}Rank`).innerText);
    return teamRankA - teamRankB;
});
